...
export default function BrandVisualizer({ onPrefillInquiry }: BrandVisualizerProps) {
  ...
  const niches: NicheData[] = [
    ...
    },
    {
      ...
      adCopy: '🌹 A selected journey through regional micro-flavors. Indulge in our fine Chef Tasting Menu tonight, featuring wild truffles, fresh burrata, and hand-rolled pasta. Seats are extremely limited. Direct booking sync only below. 👇',
    ...
    },
    {
      ...
      adCopy: '🥂 Selected beats. Hand-crafted mixology. Experience the signature nightlife vibe at Siena Lounge this weekend. Tapping below automatically registers your group to our priority guest list and secures a complimentary cocktail batch. 🎧🍸',
